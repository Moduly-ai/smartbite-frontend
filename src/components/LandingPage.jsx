        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
          <div className="text-center text-white">
            <h1 className="text-5xl md:text-6xl font-bold mb-6 leading-tight">
              ...
              <span className="block text-white opacity-80">Cash Management</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-8">
              <button
                ...
                className="btn-primary px-8 py-4 text-lg font-semibold transform hover:-translate-y-1"
              >
                Start Free 7-Day Trial
              </button>
              <button
                onClick={onSignIn}
                className="btn-secondary border-2 border-white text-white bg-transparent hover:bg-white hover:text-secondary px-8 py-4 text-lg font-semibold"
              >
                Sign In
              </button>
            </div>
