            ...
            <div className="flex">
              ...
              <div className="ml-3">
                ...
                <div className="mt-1 text-sm text-yellow-700">
                  <p>We're experiencing server connectivity issues. Owner accounts are currently created through business setup. Please use the demo credentials to explore the system or contact support.</p>
                </div>
              </div>
            </div>
          </div>
